...
$string['enddate'] = 'End';
$string['userscompleted'] = '{$a} completed';
$string['usersuncompleted'] = '{$a} uncompleted';
$string['usersenrolled'] = '{$a} enrolled';
$string['notenrolledusers'] = 'Not enrolled users';
$string['notenrolledusersfilter'] = 'Not enrolled users according with the current filter';
$string['timecompleted'] = 'Completed';
$string['student'] = 'Student';
$string['notcompletedlabel'] = 'Not completed';
$string['export'] = 'Export';
$string['onlycompleted'] = 'Only completed';
